...
1. In [proto.lua](lua/proto.lua), set `proto_path` to your proto file directory. By default, a `proto` folder will be
   created in the current directory containing Lua hint files for the protocols; this can be disabled if not needed.
...
You can use Lua scripts to batch send protocols and perform operations based on the results. Refer to existing scripts
for examples.
