dependencies {
    ...
    implementation("io.github.realm-labs.asteria:gm-script-spring-boot-starter:1.0-SNAPSHOT")
    implementation("io.github.realm-labs.asteria:script-job-mongodb-spring-boot-starter:1.0-SNAPSHOT")
