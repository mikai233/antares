dependencies {
    ...
    implementation("io.github.mikai233:gm-script-spring-boot-starter:1.0-SNAPSHOT")
    implementation("io.github.mikai233:script-job-mongodb-spring-boot-starter:1.0-SNAPSHOT")
