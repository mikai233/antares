...
inline fun <reified M> ActorSystem<*>.startSharding(
    name: String,
    role: Role,
    extractor: ShardingMessageExtractor<M, M>,
    stopMessage: M,
    ...
    return sharding.init(entity)
}

inline fun <reified M> ActorSystem<*>.startShardingProxy(
    name: String,
    role: Role,
    extractor: ShardingMessageExtractor<M, M>
): ActorRef<M> {
