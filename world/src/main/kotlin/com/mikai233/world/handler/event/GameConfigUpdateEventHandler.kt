...
@AllOpen
class GameConfigUpdateEventHandler : MessageHandler<ActorHandlerContext<WorldActor>, GameConfigUpdateEvent> {
    private val logger = logger()

    override fun handle(context: ActorHandlerContext<WorldActor>, message: GameConfigUpdateEvent) {
